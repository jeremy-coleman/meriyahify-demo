...
class Mime {
  ...
  /**
   * @type {(mimes: {[key: string]: string[]}, force?: boolean) => void};
   */
  define = function(typeMap, force) {
...
module.exports = new Mime(require('./mime_standard.js'));
